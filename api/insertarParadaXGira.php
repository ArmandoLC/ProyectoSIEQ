...
$pNombreParada = $obj["pNombreParada"];
//$pFk_IdGira = 1;
//$pNombreParada = 'ParadaX';

if($conexion){
    $consulta = "call insertarParadaXGira(".mysqli_real_escape_string($conexion,$pFk_IdGira).",'".mysqli_real_escape_string($conexion,$pNombreParada)."')";
