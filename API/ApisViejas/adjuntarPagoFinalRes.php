...
$pimgPagoFin =addslashes (file_get_contents($_FILES['pimgPagoFin']['tmp_name']));

if($conexion){
    $consulta = "call adjuntarPagoFinalRes(".mysqli_real_escape_string($conexion,$pIdReservacion).",'$pimgPagoFin')";
