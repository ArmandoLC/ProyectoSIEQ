...
$obj = cargarObjPost();
$pFk_Flotilla = $obj["pFk_Flotilla"];
$pFk_IdGira = $obj["pFk_IdGira"];
//$pFk_Flotilla = 2;
//$pFk_IdGira = 1;

if($conexion){
    $consulta = "call insertarFlotillaXGira(".mysqli_real_escape_string($conexion,$pFk_Flotilla).",".mysqli_real_escape_string($conexion,$pFk_IdGira).")";
