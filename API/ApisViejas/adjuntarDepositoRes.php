...
$pimgDep =addslashes (file_get_contents($_FILES['pimgDep']['tmp_name']));

if($conexion){
    $consulta = "call adjuntarDepositoRes(".mysqli_real_escape_string($conexion,$pIdReservacion).",'$pimgDep')";
